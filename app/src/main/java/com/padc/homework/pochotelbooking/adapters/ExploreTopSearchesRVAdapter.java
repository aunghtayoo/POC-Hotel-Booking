...
import com.padc.homework.pochotelbooking.views.viewholder.ExploreTopSearchViewHolder;

public class ExploreTopSearchesRVAdapter extends RecyclerView.Adapter {

    @NonNull
    @Override
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_view_top_search, viewGroup, false);
        return new ExploreTopSearchViewHolder(view);
    }
